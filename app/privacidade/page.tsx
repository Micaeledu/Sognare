...
export default function PrivacidadePage() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-24 text-charcoal md:px-10">
      ...
      <div className="mt-10 space-y-6 text-sm leading-relaxed text-stone">
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">1. Quem somos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">2. Dados que coletamos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">3. Uso dos dados</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">4. Compartilhamento</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">5. Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">6. Seus direitos (LGPD)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">7. Segurança</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">8. Contato</h2>
          <p>
