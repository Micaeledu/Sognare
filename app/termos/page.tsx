  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-24 text-charcoal md:px-10">
      ...
      <div className="mt-10 space-y-6 text-sm leading-relaxed text-stone">
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">1. Sobre o site</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">2. Conteúdo</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">3. Orçamentos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">4. Links externos</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-display text-lg text-charcoal">5. Contato</h2>
          <p>
